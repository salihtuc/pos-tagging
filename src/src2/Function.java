...
//					System.out.println(key + ": " + (firstVal-secondVal));
		...
		totalTransition += 156 * ((-1 * minTrans) + Double.MIN_NORMAL);	// (169) trans - (13) probs endsWith <s>  
		...
		totalEmission += ((Main.allWords.size()-1 * Main.tagSize-1) + 1) * ((-1 * minEmis) + Double.MIN_NORMAL);
